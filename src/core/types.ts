...
export interface ReportBranding {
  /** Company/organization name to display in header */
  company_name?: string;

  /** Path to logo image (PNG, JPG) for PDF/HTML reports */
  logo_path?: string;

  /** Base64 encoded logo image (alternative to logo_path) */
  logo_base64?: string;
  ...
  /** Custom footer text (replaces default "Generated by Clawck") */
  footer_text?: string;

  /** Hide "Powered by Clawck" branding entirely */
  hide_clawck_branding?: boolean;

  /** Custom CSS to inject into HTML reports */
  custom_css?: string;

  /** Custom font family for reports */
  font_family?: string;
}
